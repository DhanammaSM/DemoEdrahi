...
public class AddNewProfile {
	...
	public static void main(String[] args) {
	    ...
	    driver.findElement(By.xpath("//div[text()='Add New Profile']")).click();
	    driver.findElement(By.xpath("//span[text()='I am a Student']")).click();
	    driver.findElement(By.id("first_name")).sendKeys("Dhanamma");
	    driver.findElement(By.id("middle_name")).sendKeys("Shivaraj");
	    driver.findElement(By.id("last_name")).sendKeys("Attimarad");
	    driver.findElement(By.xpath("//img[@class='m-left-5']")).click();
